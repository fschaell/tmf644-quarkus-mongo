...
public class PartyPrivacyProfileSpecificationCreate   {
   ...
   **/
  public PartyPrivacyProfileSpecificationCreate lastUpdate(Date lastUpdate) {
  ...
  @NotNull
 @Size(min=1)  public List<PartyPrivacyProfileSpecificationCharacteristic> getPartyPrivacyProfileSpecCharacteristic() {
